...
import { Brain, Code2, Cpu, Database, MapPin, Briefcase } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            ...
            >
              <p className="text-muted-foreground text-lg leading-relaxed">
                ...
                end-to-end machine learning pipelines and deploying intelligent systems.
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                <span className="text-secondary"> Computer Vision</span>. I work with Python, 
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                not just functional but also scalable and production-ready.
              </p>
